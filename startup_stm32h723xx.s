...
.word  _eitcm_text
/* start address for the initialization values of the .dtcm_data section.
defined in linker script */
.word  _sidtcm_data
/* start address for the .dtcm_data section. defined in linker script */
.word  _sdtcm_data
/* end address for the .dtcm_data section. defined in linker script */
.word  _edtcm_data
/* start address for the .dtcm_bss section. defined in linker script */
.word  _sdtcm_bss
/* end address for the .dtcm_bss section. defined in linker script */
.word  _edtcm_bss
...
/* Copy the ITCM text segment initializers from flash to ITCM */
  ldr r0, =_sitcm_text
  ldr r1, =_eitcm_text
  ldr r2, =_siitcm_text
  movs r3, #0
  b LoopCopyITCMTextInit
...
LoopCopyITCMTextInit:
  adds r4, r0, r3
  cmp r4, r1
  bcc CopyITCMTextInit

/* Copy the DTCM data segment initializers from flash to DTCM */
  ldr r0, =_sdtcm_data
  ldr r1, =_edtcm_data
  ldr r2, =_sidtcm_data
  movs r3, #0
